namespace Booker.Data
{
    ...
    public static class SeedData
    {
        ...
        public static List<Book> Books = new List<Book>
        {
            ...
            CreateBook(title: "Ponad słowami 2 cz. 2", subjectId: 1, levelId: 3, grades: new() { 2 }),
            CreateBook(title: "Ponad słowami 3 cz. 1", subjectId: 1, levelId: 3, grades: new() { 3 }),
            CreateBook(title: "Ponad słowami 3 cz. 2", subjectId: 1, levelId: 3, grades: new() { 4 }),
            CreateBook(title: "Ponad słowami 4", subjectId: 1, levelId: 3, grades: new() { 5 }),

            // Język angielski
            CreateBook(title: "Focus 2 Podręcznik", subjectId: 2, levelId: 3, grades: new() { 1 }),
            CreateBook(title: "Focus 3 Podręcznik", subjectId: 2, levelId: 3, grades: new() { 1 }),
            CreateBook(title: "Focus 4 Podręcznik", subjectId: 2, levelId: 3, grades: new() { 2 }),
            CreateBook(title: "Focus 5 Podręcznik", subjectId: 2, levelId: 3, grades: new() { 2 }),
            CreateBook(title: "Focus 2 Ćwiczenia", subjectId: 2, levelId: 3, grades: new() { 3 }),
            CreateBook(title: "Focus 3 Ćwiczenia", subjectId: 2, levelId: 3, grades: new() { 3 }),
            CreateBook(title: "Focus 4 Ćwiczenia", subjectId: 2, levelId: 3, grades: new() { 4 }),
            CreateBook(title: "Focus 5 Ćwiczenia", subjectId: 2, levelId: 3, grades: new() { 4 }),
            CreateBook(title: "My matura perspectives [nowa era]", subjectId: 2, levelId: 3, grades: new() { 5 }),
            ...
            CreateBook(title: "Welttour Deutsch 2", subjectId: 3, levelId: 3, grades: new() { 2 }),
            CreateBook(title: "Welttour Deutsch 3", subjectId: 3, levelId: 3, grades: new() { 3 }),
            CreateBook(title: "Welttour Deutsch 4", subjectId: 3, levelId: 3, grades: new() { 4 }),
            CreateBook(title: "Effekt 1", subjectId: 3, levelId: 3, grades: new() { 1 }),
            CreateBook(title: "Effekt 2", subjectId: 3, levelId: 3, grades: new() { 2 }),
            CreateBook(title: "Effekt 3", subjectId: 3, levelId: 3, grades: new() { 3 }),
            CreateBook(title: "Effekt 4", subjectId: 3, levelId: 3, grades: new() { 4 }),

            // Biologia
            CreateBook(title: "Biologia na czasie 1", subjectId: 4, levelId: 1, grades: new() { 1 }),
            CreateBook(title: "Biologia na czasie 2", subjectId: 4, levelId: 1, grades: new() { 2 }),
            CreateBook(title: "Biologia na czasie 3", subjectId: 4, levelId: 1, grades: new() { 3 }),
            ...
            // Chemia
            CreateBook(title: "To jest chemia 1", subjectId: 5, levelId: 1, grades: new() { 1 }),
            CreateBook(title: "To jest chemia 2", subjectId: 5, levelId: 1, grades: new() { 2 }),
            CreateBook(title: "To jest chemia 1", subjectId: 5, levelId: 2, grades: new() { 1 }),
            CreateBook(title: "To jest chemia 2", subjectId: 5, levelId: 2, grades: new() { 2 }),
            ...
            CreateBook(title: "Fizyka 4 [wsip]", subjectId: 7, levelId: 2, grades: new() { 4 }),
            ...
            CreateBook(title: "Fizyka 4 [wsip]", subjectId: 7, levelId: 1, grades: new() { 4 }),

            // Geografia
            CreateBook(title: "Oblicza geografii 1", subjectId: 8, levelId: 1, grades: new() { 1 }),
            CreateBook(title: "Oblicza geografii 2", subjectId: 8, levelId: 1, grades: new() { 2 }),
            CreateBook(title: "Oblicz geografii karty pracy 1", subjectId: 8, levelId: 1, grades: new() { 1 }),
            CreateBook(title: "Oblicz geografii karty pracy 2", subjectId: 8, levelId: 1, grades: new() { 2 }),
            ...
            CreateBook(title: "Historia [wsip] 4", subjectId: 9, levelId: 1, grades: new() { 4 }),
            ...
            // Informatyka
            CreateBook(title: "Informatyka [operon]", subjectId: 11, levelId: 1, grades: new() { 1 }),
            CreateBook(title: "Informatyka dla szkół ponadgimnazjalnych [Migra]", subjectId: 11, levelId: 1, grades: new() { 2 }),
            CreateBook(title: "Informatyka [operon]", subjectId: 11, levelId: 2, grades: new() { 1 }),
            CreateBook(title: "Informatyka dla szkół ponadgimnazjalnych [Migra]", subjectId: 11, levelId: 2, grades: new() { 2 }),

            // Matematyka
            CreateBook(title: "NOWA MATeMAtyka 1", subjectId: 12, levelId: 1, grades: new() { 1 }),
            CreateBook(title: "NOWA MATeMAtyka 2", subjectId: 12, levelId: 1, grades: new() { 2 }),
            CreateBook(title: "NOWA MATeMAtyka 3", subjectId: 12, levelId: 1, grades: new() { 3 }),
            CreateBook(title: "NOWA MATeMAtyka 4", subjectId: 12, levelId: 1, grades: new() { 4 }),
            CreateBook(title: "NOWA MATeMAtyka 1", subjectId: 12, levelId: 3, grades: new() { 1 }),
            CreateBook(title: "NOWA MATeMAtyka 2", subjectId: 12, levelId: 3, grades: new() { 2 }),
            CreateBook(title: "NOWA MATeMAtyka 3", subjectId: 12, levelId: 3, grades: new() { 3 }),
            CreateBook(title: "NOWA MATeMAtyka 4", subjectId: 12, levelId: 3, grades: new() { 4 }),
            ...
            // WOS
            CreateBook(title: "W centrum uwagi 1", subjectId: 16, levelId: 1, grades: new() { 4 }),
