...
public static class AdminNavPages
{
    ...
    public static string GuardianConsents => "GuardianConsents";
    ...
    public static string GuardianConsentsNavClass(ViewContext viewContext) => PageNavClass(viewContext, GuardianConsents);
